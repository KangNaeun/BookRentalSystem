...
<body>
	...
	<%
		...
		String mname = request.getParameter("insert_mname"); //고객이름
		String maddress = request.getParameter("insert_maddress");//고객주소
		String mphone = request.getParameter("insert_mphone");//고객전화번호
