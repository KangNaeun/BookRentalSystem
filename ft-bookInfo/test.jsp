            ...
            <% request.setCharacterEncoding("UTF-8"); BookDAO bookDAO=new BookDAO();
                ...
                List<String> db_params = new ArrayList<>();
                        ...
                        for (int i = 0; i < params.length; i++) { if (params[i] !=null) {
                            ...
                            switch (targetNo) { case 0: int bookno=Integer.parseInt(booknoSTR);
                            ...
                            getBookList=bookDAO.getBookGnameList(gname); break; case 5: int
                            bcount=Integer.parseInt(bcountSTR);
                            getBookList=bookDAO.getBookCountList(bcount); break; } } } if
                            (isEmptyStr) { getBookList=bookDAO.getBookList(); } if(getBookList
                            !=null){ for(Book2DTO bookList : getBookList) { %>
                            <tr>
                                <td>
                                    <%=bookList.getBookno()%>
                                </td>
